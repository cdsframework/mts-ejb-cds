...
import org.cdsframework.ejb.bo.CdsListBO;
...
@Startup
@Singleton
public class CdsPlugin extends BasePlugin {
    ...
    protected void postProcess() throws MtsException {
        registerProperty("CDS_SUPPORTED_IMPORT_MIME_TYPES", Arrays.asList(
                propertyMGRLocal.get("CDS_SUPPORTED_IMPORT_MIME_TYPES", String.class).split(CoreConstants.WHITESPACE_COMMA_REGEX)));
        cdsListBO.verifyEnumLists();
    }
}
