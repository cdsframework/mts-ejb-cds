 ...
 */
@Stateless
public class DataTemplateDAO extends BaseDAO<DataTemplateDTO> {
            ...
            public String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                ...
                if (!StringUtils.isEmpty(text)) {
                    setWildcardPredicateValue(baseDTO,
                            " ( lower(description) like :text OR lower(code) like :text OR lower(template_id) like :text OR lower(name) like :text OR lower(oid) like :text ) ", "text");
