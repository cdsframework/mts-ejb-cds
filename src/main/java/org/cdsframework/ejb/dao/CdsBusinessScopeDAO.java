...
@Stateless
@LocalBean
public class CdsBusinessScopeDAO extends BaseDAO<CdsBusinessScopeDTO> {
    ...
    protected void initialize() throws MtsException {
        ...
        this.registerDML(ByGeneralProperties.class, new QueryCallback(getDtoTableName()) {
            ...
            public String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                setWildcardPredicateValue(baseDTO, " lower(business_id) like :text ", "text");
                setWildcardPredicateValue(baseDTO, " lower(scoping_entity_id) like :text ", "text");
        ...
        this.registerDML(CdsBusinessScopeDTO.ByScopeBusinessId.class, new QueryCallback(getDtoTableName()) {

            @Override
            protected String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                return "select * from cds_business_scope where business_id = :business_id and scoping_entity_id = :scoping_entity_id";
            }
        }, false);
    }
}
