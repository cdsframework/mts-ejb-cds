 ...
 */
@Stateless
public class CriteriaResourceDAO extends BaseDAO<CriteriaResourceDTO> {
            ...
            public String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                ...
                if (!StringUtils.isEmpty(text)) {
                    setWildcardPredicateValue(baseDTO,
                            " ( lower(description) like :text OR lower(resource_type) like :text OR lower(resource_id) like :text OR lower(name) like :text ) ", "text");
