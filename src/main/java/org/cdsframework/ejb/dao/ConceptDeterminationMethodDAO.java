...
@Stateless
@LocalBean
public class ConceptDeterminationMethodDAO extends BaseDAO<ConceptDeterminationMethodDTO> {
    ...
    protected void initialize() throws MtsException {
        ...
        this.registerDML(ConceptDeterminationMethodDTO.ByCode.class, new QueryCallback(getDtoTableName()) {

            @Override
            protected String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                return "select * from concept_determination_method where code = :code";
            }
        }, false);
    }
}
