 ...
 */
@Stateless
public class DataModelDAO extends BaseDAO<DataModelDTO> {
            ...
            public String getQueryDML(BaseDTO baseDTO, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO) {
                ...
                if (!StringUtils.isEmpty(text)) {
                    setWildcardPredicateValue(baseDTO,
                            " ( lower(description) like :text OR lower(version) like :text OR lower(model_id) like :text OR lower(name) like :text ) ", "text");
