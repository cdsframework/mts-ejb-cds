 ...
 */
@Stateless
public class ValueSetSubValueSetRelBO extends BaseBO<ValueSetSubValueSetRelDTO> {
    ...
    @Override
    protected Map<String, Object> preAddOrUpdate(ValueSetSubValueSetRelDTO baseDTO, Operation operation, Class queryClass, SessionDTO sessionDTO, PropertyBagDTO propertyBagDTO)
        ...
        if (baseDTO == null || baseDTO.getSubValueSetDTO()== null || baseDTO.getSubValueSetDTO().getValueSetId()== null) {
            BrokenRule brokenRule = new BrokenRule("ValueSetSubValueSetRelDTOValueSetMissing", "A value set must be selected.");
